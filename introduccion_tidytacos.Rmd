...
no es necesario importarlo ni convertirlo. Se llama “vdata” y comenzamos inspeccionando 
...
Luego echamos un vistazo rápido al número total de muestras, ASV y lecturas (reads en inglés) 
en el objeto tidytacos:
...
efecto de las variables de muestra en las diferencias de Bray-Curtis de las 
